...
public class LoadingBar : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        bool isNeedSkipArmed = SceneManager.GetActiveScene().name.Equals("CockpitScene");
        
        if ((isNeedSkipArmed || m_Armed) && PointOfViewWithinArea(cameraPosition, cameraLookDirection))
        {
            StartLoading();
        } else if (m_Loading)
        {
